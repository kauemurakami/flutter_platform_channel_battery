...
Veja o resultado no iOS
Código fonte do projeto
GitHub - kauemurakami/flutter_platform_channel_battery: Usando platform channel para interagir…
Usando platform channel para interagir nativamente um app dart com Android (via kotlin) e iOS (via swift) - GitHub …github.com
Também contei com a ajuda do Luigi Gontijo, confira o github dele.
gontijol - Overview
Mobile Developer | Computer Science . gontijol has 44 repositories available. Follow their code on GitHub.github.com
Pronto
...
Fonte
Este artigo tem como base o mesmo projeto que pode ser encontrado aqui flutter.dev